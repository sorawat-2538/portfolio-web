...
export const dataAnalysis: DataAnalysisContent = {
  overview: [
    "อีกหนึ่งบทบาทที่ทำแยกออกมาจากงานโปรเจกต์คือการทำ Business Analyst โดยต่อยอดจากข้อมูลหลังบ้านที่มีอยู่ใน Zimple Analytic นำมาวิเคราะห์เพื่อค้นหา insight และช่องทางในการยกระดับเว็บไซต์ คัดกรองสิ่งที่มีคุณค่ามากที่สุดแล้วแปลงเป็นไอเดียสำหรับนำไปเสนอและพัฒนาต่อ จากนั้นวางเวิร์กโฟลว์ร่วมกับ AI เพื่อแปลงไอเดียออกมาเป็นภาพได้อย่างรวดเร็วและเห็นผลเป็นรูปธรรมตั้งแต่ต้น เสนอแล้วหากไม่ตรงความต้องการก็ปรับหรือเริ่มใหม่ได้ทันที ช่วยให้รอบการทดลองไอเดียเร็วขึ้นและต้นทุนการทิ้งงานต่ำ",
  ],
  ...
  sections: [
    {
      ...
      goal: "ใช้ data ตั้งโจทย์ให้ตัวเอง — ไล่ดูจาก Zimple Analytics ว่าหน้าไหนของ Propertyhub เป็นจุดที่เกิด revenue มากที่สุด เจอว่าเป็น Listing Detail แต่ 3 ใน 4 ของ session ดูแค่ประกาศเดียวแล้วออก ตัวเลขนี้เลยกลายเป็นโจทย์ออกแบบ",
      steps: [
        {
