...
export const profile = {
  ...
  hero: {
    ...
    emoji: "👋",
    intro:
      "UX/UI & Product Designer จบจากศิลปากร เอกออกแบบเว็บและสื่อโต้ตอบ และทำงานสายออกแบบมาตลอดตั้งแต่วันแรกที่เริ่มทำงาน ตลอด 7 ปีที่ผ่านมาเป็นดีไซเนอร์คนเดียวของบริษัท รับโจทย์เอง คิดเอง จบงานเอง ทั้งสาย construction และ real estate",
    statement:
      "งานออกแบบที่ดีเริ่มจากความใส่ใจ ตั้งแต่ภาพรวมไปจนถึงทุกพิกเซล",
  ...
  about: [
    "เป็นคนที่มี ownership สูงและรักในงานที่ทำ การได้เป็นดีไซเนอร์คนเดียวในบริษัทสอนให้รับโจทย์เอง คิด flow เอง และส่งมอบงานจนจบได้ด้วยตัวเอง",
    "ใส่ใจรายละเอียดระดับ pixel perfect เรียนรู้สิ่งใหม่ได้เร็ว และทำงานกับ developer ได้ลื่นไหล เพราะมีพื้นความรู้เรื่องโค้ดอยู่บ้าง ปัจจุบันยังนำ AI เข้ามาช่วยในกระบวนการออกแบบให้เร็วและดีขึ้นด้วย",
  ],
  ...
  aboutSummary:
    "ประสบการณ์กว่า 7+ ปีในสายงาน Design และมีส่วนร่วมในโปรเจกต์มากกว่า 10+ โปรเจกต์ ครอบคลุมทั้งบริษัท Startup ด้าน Construction และบริษัท Digital Platform โดยรับผิดชอบงานออกแบบตั้งแต่ต้นจนจบ ตั้งแต่การทำความเข้าใจปัญหา วางแนวทาง UX/UI ไปจนถึงการส่งมอบงาน พร้อมผสานความรู้ด้าน Design, AI และ Technology เพื่อพัฒนาประสบการณ์และสร้างโซลูชันที่ตอบโจทย์ผู้ใช้งานและธุรกิจ",
